...
namespace Laclasse.Authentication {
 ...
 if (info != null) { 
            ...
            this.Write(@"
                    <div style=""display: flex; flex-direction: row; padding: 20px; margin-bottom: 20px; background-color: #f3eff0;"" id=""info-content"">
                        ...
                        <div style=""margin-left: 20px; align-self: center; text-align: left; color: #628e4e; font-size: 18px;"">
                            <div>
                                ");
 ...
 first = ""; } 
            ...
            this.Write("\" id=\"authentication-content\">\n\t\t\t\t\t\t\t<div class=\"boxHeader\">Connectez-vous</div>" +
                    "\n\n                            <div class=\"authBox\">\n    \t\t\t\t\t\t\t<div style=\"margi" +
                    "n-bottom: 0px; flex: 1; display: flex; flex-direction: column;\">\n    \t\t\t\t\t\t\t\t<di" +
                    "v class=\"title\" style=\"position: relative; top: -8px\">avec un compte partenaire " +
                    ": \n                                        <a href=\"https://ent-laclasse.blogs.l" +
                    "aclasse.com/2018/08/27/saisir-les-identifiants-et-mots-de-passe-au-bon-endroit/\"" +
                    " target=\"_blank\">\n                                            <svg xmlns=\"http:/" +
                    "/www.w3.org/2000/svg\" viewBox=\"0 0 48 48\" version=\"1.1\" style=\"fill: #0074c1; po" +
                    "sition: relative; top: 8px; width: 28px; height: 28px; margin-left: 10px\">\n     " +
                    "                                           <path d=\"M24 4C6.2 4-2.7 25.5 9.9 38." +
                    "1 22.5 50.7 44 41.8 44 24 44 13 35 4 24 4zM23.5 8C31.9 7.8 40 14.2 40 24 40 32.8" +
                    " 32.8 40 24 40 9.7 40 2.6 22.8 12.7 12.7 15.8 9.5 19.7 8.1 23.5 8zM24 12C19.6 12" +
                    " 16 15.6 16 20L20 20C20 14.7 28 14.7 28 20 28 24 22 23.5 22 30L26 30C26 25.5 32 " +
                    "25 32 20 32 15.6 28.4 12 24 12zM24 32.2A2.9 2.9 0 0 0 21.1 35.1 2.9 2.9 0 0 0 24" +
                    " 38 2.9 2.9 0 0 0 26.9 35.1 2.9 2.9 0 0 0 24 32.2z\" />\n                         " +
                    "                   </svg>\n                                        </a>\n         " +
                    "                           </div>\n                                    <a class=\"" +
                    "btn\" style=\"padding: 6px; padding-left: 10px; background-color: #9b0383; display" +
                    ": flex; flex-direction: row;\" href=\"parentPortalIdp?service=");
